define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "speedings",
            "description": "<p>speed count of the trip.(optional)</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    "type": "get",
    "url": "/:tenantId/config",
    "title": "Get Config details",
    "version": "1.0.0",
    "name": "Get_Config_details",
    "group": "Trips",
    "description": "<p>Get Config Details.</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -X GET  -d \"\" http://localhost:3303/80201e76-3360-48d3-9804-e5e6a6a4edcb/config -H \"Autherization:<access-token>\" -H \"Content-Type: application/json\"",
        "type": "json"
      }
    ],
    "header": {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3303/80201e76-3360-48d3-9804-e5e6a6a4edcb/config"
      }
    ],
    "filename": "routes/trip.js",
    "groupTitle": "Trips"
